Task_info *t0 = new Task_info(0, 0, 25000, 20000, 4000, 0, 1, 1, 1, 25000, -1, "CC1", s5);
whole_tasks.push_back(t0);
Task_info *t1 = new Task_info(1, 0, 40000, 30000, 6000, 0, 1, 1, 1, 40000, -1, "LK1", s3);
whole_tasks.push_back(t1);
Task_info *t2 = new Task_info(2, 0, 60000, 50000, 10000, 0, 1, 1, 1, 60000, -1, "CC2", s0);
whole_tasks.push_back(t2);
Task_info *t3 = new Task_info(3, 0, 60000, 50000, 10000, 0, 1, 1, 1, 60000, -1, "LK2", s4);
...
Task_info *t7 = new Task_info(7, 0, 130000, 120000, 24000, 0, 1, 1, 1, 130000, -1, "LK3", s1);
